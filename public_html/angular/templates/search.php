...
<div class="row">
	...
	<div class="col-md-6">
		<div class="well text-center">
			<form name="searchForm" id="searchForm" class="form-horizontal well"
					ng-submit="getSearch(formData, searchForm.$valid);" novalidate>
				<div class="form-group"
					  ng-class="{ 'has-error': searchForm.fullName.$touched && searchForm.fullName.$invalid }">
					...
					<div class="input-group">
						...
						<input type="text" id="search" name="search" class="form-control" placeholder="search"
								 ng-model="formData.search" ng-minlength="1" ng-maxlength="32" ng-required="true"/>
					</div>
					<div class="alert alert-danger" role="alert" ng-messages="searchForm.search.$error"
						  ng-if="searchForm.search.$touched" ng-hide="searchForm.search.$valid">
